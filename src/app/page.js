...
export default function Home() {
  ...
  const recipient = "ramdassinghmt30@gmail.com";
  ...
  return (
    <>
      ...
      <header
        data-aos="zoom-in"
        className="fixed inset-x-0 top-0 z-50 bg-black/90 backdrop-blur border-b-2 border-yellow-300 shadow-md"
      >
        <div className="container mx-auto flex h-16 items-center justify-between px-4 lg:px-6">
          ...
          <button
            ref={buttonRef}
            onClick={handleNav}
            className={`md:hidden relative z-50 flex flex-col justify-center items-center w-10 h-10 rounded focus:outline-none transition duration-300 ${
              navOpen ? "bg-yellow-400 text-black" : "bg-transparent text-white"
            }`}
                ...
                item.scroll ? (
                  <li key={item.label}>
                    <ScrollLink
                      ...
                      smooth
                      duration={400}
                      className="hover:text-gray-900 hover:font-medium hover:bg-yellow-400 py-2 px-2 rounded cursor-pointer"
                      onClick={() => setNavOpen(false)}
                    >
                      {item.label}
                    </ScrollLink>
        ...
        >
          <ul className="mt-[66px] flex flex-col gap-6 px-6 py-4 text-lg font-medium bg-black z-10">
            {navItems.map((item) =>
              item.scroll ? (
                <li key={item.label}>
                  <ScrollLink
      ...
      <main className=" bg-black text-white w-full">
        ...
        <section
          id="hero"
          className="flex flex-col md:flex-row gap-20 items-center justify-between mx-10 md:mx-10 py-20"
        >
          <div className="text-left w-full md:w-1/2 py-10 sm:py-0">
            <h2
              data-aos="fade-right"
          ...
          <div
            data-aos="fade-left"
            className="w-full md:w-1/2 flex justify-center m-5"
          >
            <img
              src="/computer1.jpg"
              alt="profile"
              className="w-50 h-50 shadow-lg mt-5"
            />
          </div>
        </section>
        ...
        <section
          data-aos="fade-down"
          id="about"
          className="text-left mx-10 py-20 mt-20"
        >
          <h1
            data-aos="zoom-out"
          ...
          <h2 className="text-4xl font-bold">
            Hey, I'm <span className="text-yellow-400">Ramdas Singh</span>
            <br />
            <span className="text-purple-600"> MERN Stack Developer</span>
            <br />
            who thrives on building high-performance,
            <br /> scalable, and user-centric applications.
          </h2>
          ...
          <p className="mt-5 text-xl leading-relaxed">
            I thrive in fast-paced environments, love debugging the impossible,
            and constantly push myself to learn, adapt, and innovate. Whether
            it’s optimizing APIs for speed, architecting scalable databases, or
            designing pixel-perfect frontends, I bring a problem-solving mindset
          ...
          <div data-aos="zoom-out" className="mt-8">
            <a
              href="/Ramdas Singh D.pdf"
              download
              className="bg-yellow-500 text-black px-6 py-3 text-lg font-semibold rounded-lg shadow-lg hover:bg-yellow-400 transition duration-300"
            >
              📄 Download CV
            </a>
          </div>
        ...
        <section id="skills" className="mx-10 py-20 mt-10">
          <h3
            data-aos="zoom-out"
            className="text-6xl text-center font-bold mb-12"
          >
            Skills
          </h3>
          <div
            data-aos="zoom-in"
            className="grid grid-cols-1 md:grid-cols-2 gap-12 px-6"
          >
            {/* Frontend Skills */}
        ...
        <section id="projects" className="py-20 px-10">
          ...
          >
            {[
              ...
              <div
                key={index}
                className="p-4 border rounded-lg shadow bg-gray-800 transition transform hover:scale-105 hover:shadow-2xl hover:border-yellow-400 hover:bg-gray-700 duration-300"
              >
                <img
                  src={project.img}
                  alt={project.title}
                ...
                <a
                  href={project.link}
                  target="_blank"
                  className="mt-4 inline-block bg-yellow-500 text-black px-4 py-2 rounded-lg font-semibold hover:bg-yellow-400 transition duration-300"
                >
                  Live Demo
                </a>
              </div>
      ...
      <footer className="bg-gray-900 text-white text-center p-4">
        <div className="flex justify-center space-x-6 mb-3">
          <a
            ...
            data-aos-delay="300"
            href="https://wa.me/9877323956"
            target="_blank"
            rel="noopener noreferrer"
            className="text-green-600 text-4xl hover:text-green-500 aos-init aos-animate"
          >
            <FaWhatsapp />
          </a>
          <a
            ...
            data-aos-duration="700"
            data-aos-delay="400"
            href="https://github.com/Ramdas-developer"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            ...
            data-aos-duration="700"
            data-aos-delay="500"
            href="https://www.linkedin.com/in/ramdas-singh/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-400 text-4xl hover:text-blue-500"
          >
            <FaLinkedin />
          </a>
          <a
            ...
            className="text-red-400 text-4xl hover:text-red-500"
            rel="noopener noreferrer"
            target="_blank"
          >
            <FaEnvelope />
